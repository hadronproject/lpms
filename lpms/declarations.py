...
class ConstantValues:
    ...
    def __init__(self):
        ...
        self.val.installdb = "installdb"
        self.val.db_prefix = ".db"
        self.val.reverse_dependsdb = "reverse_dependsdb"
        self.val.reverse_dependsdb_path = "/var/db/lpms/reverse_depends.db"
        self.val.file_relationsdb = "file_relationsdb"
        self.val.file_relationsdb_path = "/var/db/lpms/file_relationsdb"
        ...
        self.val.sandbox_app = executable_path("sydbox")
